        ...
        <div className="lg:col-span-4 flex flex-col gap-8 h-fit">
          ...
          >
            ...
            <div className="flex flex-col gap-4 mt-auto">
              <a href="https://wa.me/5511966142927" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-[#25D366]/20 ring-1 ring-white/10 hover:ring-[#25D366]/50 transition-all duration-300">
